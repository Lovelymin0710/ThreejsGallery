...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/sw/swimage03.png"),}),
    ...
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/sw/swinfoimage03.png"), outline:true}),
    ...
    fontLoader.load("../../font/Do Hyeon_Regular.json", (font) => {
        const geometry = new TextGeometry("서연고", {
            font: font,
            size: 11,
            height: 1,
        });
