...
const init = () => {
    ...
    const material1 = new THREE.MeshBasicMaterial({map: loader.load("../../image/sw/swimage06.png"),}),
    ...
    const infogeometry = new THREE.BoxGeometry(50, 30, 3);
    const infomaterial = new THREE.MeshBasicMaterial({map: loader.load("../../image/sw/swinfoimage06.png"), outline:true}),
    ...
    fontLoader.load("../../font/Do Hyeon_Regular.json", (font) => {
        const geometry = new TextGeometry("교대로", {
            font: font,
            size: 11,
            height: 1,
        });
